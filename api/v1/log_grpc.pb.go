...
const (
	...
	Log_GetServers_FullMethodName    = "/log_v1.Log/GetServers"
)
...
func (c *logClient) ProduceStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ProduceRequest, ProduceResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Log_ProduceStreamClient = grpc.ClientStreamingClient[ProduceRequest, ProduceResponse]
...
func (UnimplementedLogServer) ProduceStream(grpc.ClientStreamingServer[ProduceRequest, ProduceResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Log_ProduceStreamServer = grpc.ClientStreamingServer[ProduceRequest, ProduceResponse]
