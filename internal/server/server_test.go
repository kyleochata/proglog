...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	//newClient helper function to create a root client with the correct perm and a nobody client to test authorization
	newClient := func(crtPath, keyPath string) (*grpc.ClientConn, api.LogClient, grpc.DialOption) {
		...
		opts := grpc.WithTransportCredentials(tlsCreds)
...
func testUnauthorized(t *testing.T, _, client api.LogClient, _ *Config) {
	...
	if gotCode != wantCode {
		t.Fatalf("got: %d, want: %d", gotCode, wantCode)
	}
